...
<div class="info-box">
  <i>`r emoji::emoji("parrot")`</i> Just switch the environment variable like you switch a light switch, and your code will adapt automatically.
</div>
...
<div class="info-box">
  <i>`r emoji::emoji("parrot")`</i> By adopting this guide, we avoid the overhead of defining and maintaining our own custom rules; and we ensure that our code is immediately familiar to anyone experienced with the broader R community.
...
The lintr package can automatically flag deviations from your style guide.
...
The styler package can reformat your code to match a consistent layout with a single command.
